...
print(f'Previsão de fechamento para 04/05/2024 (Prophet): {previsao_prophet["yhat"].values[0]:.2f}')
print(f'Previsão de fechamento para 04/05/2024 (LSTM): {previsao_lstm[0, 0]:.2f}')
